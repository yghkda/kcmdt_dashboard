window.KGLD_DASHBOARD_DATA = {
  ...
  "status": "공급 변동",
  "statusLevel": "watch",
  "statusMessage": "관찰 사실: 최근 24시간 KGLD Transfer 1건. 발행 246 KGLD, 소각 0 KGLD. Issue 유입 246 / 유출 0 KGLD. Redeem 유입 0 / 유출 0 KGLD. 추정: Issue 컨트랙트가 발행 자산의 과반을 보관 중이므로 운영 배포 흐름의 집중도가 높습니다. 최근 24시간 공급량 변동이 발생했으므로 발행·소각 트랜잭션과 운영 사유를 대조해야 합니다.",
  "contracts": {
  ...
  "kpis": [
    { "label": "총공급량", "value": "247.20492435", "unit": "KGLD", "change": "0", "tone": "neutral" },
    { "label": "24시간 전송", "value": "1", "unit": "건", "change": "0", "tone": "watch" },
    { "label": "24시간 거래량", "value": "246", "unit": "KGLD", "change": "0", "tone": "watch" },
    { "label": "발행", "value": "246", "unit": "KGLD", "change": "0", "tone": "watch" },
    { "label": "소각", "value": "0", "unit": "KGLD", "change": "0", "tone": "neutral" },
    { "label": "Issue 보관 비중", "value": "99.72", "unit": "%", "change": "0", "tone": "watch" }
  ],
  "balances": {
    "issue": { "value": 246.53263476, "percentage": 99.72, "change": 0 },
    "redeem": { "value": 0.50082762, "percentage": 0.2, "change": 0 },
    "circulating": { "value": 0.17146197, "percentage": 0.06, "change": 0 }
  },
  "activity": {
    "issue": {
      "inbound": 246,
